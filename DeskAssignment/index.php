			...
			function finalize() {
					...
					xmlhttp.onreadystatechange=function() {
						if (this.readyState==4 && this.status==200) {
							...
							window.location.href = "https://csclub.uwaterloo.ca/~pghosh/DeskAssignment/index.php"
						}
					}
	...
	<body>
		...
		function yet(){
			...
			if (IDUser==EmployeeNumber){
				window.location.href = "https://csclub.uwaterloo.ca/~pghosh/DeskAssignment/employee.php"
			}
			else if (IDUser==SupervisorNumber){
				window.location.href = "https://csclub.uwaterloo.ca/~pghosh/DeskAssignment/supervisor.php"
			}
			else if (IDUser==CEONumber){
				window.location.href = "https://csclub.uwaterloo.ca/~pghosh/DeskAssignment/Man.php"
			}
			else{
		...
		<h1 class="site"><a href="https://csclub.uwaterloo.ca/~pghosh/DeskAssignment/index.php">Ikea Desks</a></h1>
		<br>
		<div class="right">
			<p>Staff Member?</p>
			<label> ID: </label>
