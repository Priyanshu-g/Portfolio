...
echo '</table>';
echo '<div style="display:inline;" class="right" id="Op2"></div><br><br><br><br><br><table style="float:left;"><tr id="borderloss"><th id="ead"><button onclick="dlete()" id="dlete" class="button"><span>Delete Order </span></button></th><th id="ad"><button onclick="change()" id="change" class="button"><span>Change Order </span></button></th></tr></table><p id="instructions"></p></div>';
?>