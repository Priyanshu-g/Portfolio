...
<html>
	...
	<head>
		...
		<script>
			...
			function send2(x,y){
				...
				if(newNum < 0){
					y.innerHTML+='<p>Number must be positive</p>'
					return;
				}
				if (window.XMLHttpRequest) {
					xmlhttp=new XMLHttpRequest();
				...
				xmlhttp.open("GET","basecosts.php?x="+x+"&NN="+newNum,true);
				xmlhttp.send()
			}
	...
	<body>
		<h1 class="site"><a href="https://csclub.uwaterloo.ca/~pghosh/DeskAssignment/">Ikea Desks</a></h1>
		<br>
		<br>
		<h2>Manager </h2>
		<br>
